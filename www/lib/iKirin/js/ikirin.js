 ...
 * HTML5 Web App
 * 
 * http://o2o.ab1.auo.com/ikirin
 * 
 * Copyright 2016, obov
 * The iKylin
 * http://o2o.ab1.auo.com/
 * 
 * Licensed under MIT
 * 
...
(function () {
        ...
        ************   Views   ************
        ...
        var View = function (selector, params) {
            ...
            if (typeof selector !== 'string') {
                // Supposed to be HTMLElement or ZeJS
    ...
    var ZeJS = (function () {
        ...
        ZeJS.prototype = {
            ...
            is: function (selector) {
                ...
                if (typeof selector === 'string') {
                    ...
                    if (selector.nodeType || selector instanceof ZeJS) {
            ...
            eq: function (index) {
                ...
                if (index < 0) {
                    ...
                    if (returnIndex < 0) return new ZeJS([]);
                    else return new ZeJS([this[returnIndex]]);
                }
                return new ZeJS([this[index]]);
            },
            append: function (newChild) {
                ...
                for (i = 0; i < this.length; i++) {
                    ...
                    else if (newChild instanceof ZeJS) {
            ...
            next: function (selector) {
                if (this.length > 0) {
                    if (selector) {
                        if (this[0].nextElementSibling && $(this[0].nextElementSibling).is(selector)) return new ZeJS([this[0].nextElementSibling]);
                        else return new ZeJS([]);
                    }
                    else {
                        if (this[0].nextElementSibling) return new ZeJS([this[0].nextElementSibling]);
                        else return new ZeJS([]);
                    }
                }
                else return new ZeJS([]);
            ...
            nextAll: function (selector) {
                ...
                return new ZeJS(nextEls);
            },
            prev: function (selector) {
                if (this.length > 0) {
                    if (selector) {
                        if (this[0].previousElementSibling && $(this[0].previousElementSibling).is(selector)) return new ZeJS([this[0].previousElementSibling]);
                        else return new ZeJS([]);
                    }
                    else {
                        if (this[0].previousElementSibling) return new ZeJS([this[0].previousElementSibling]);
                        else return new ZeJS([]);
                    }
                }
                else return new ZeJS([]);
            ...
            children: function (selector) {
                ...
                return new ZeJS($.unique(children));
            },
            remove: function () {
                for (var i = 0; i < this.length; i++) {
        ...
        (function () {
            ...
            function createMethod(name) {
                ZeJS.prototype[name] = function (targetSelector, listener, capture) {
                    var i;
        ...
        $.each = function (obj, callback) {
            ...
            if (!callback) return;
            var i, prop;
            if ($.isArray(obj) || obj instanceof ZeJS) {
                // Array
    ...
    ===========================*/
    iKirin.prototype.support = (function () {
        var support = {
    ...
    Device/OS Detection
    ===========================*/
    iKirin.prototype.device = (function () {
        var device = {};
    ...
    window.Swiper = function (container, params) {
        ...
        var originalParams = {};
        for (var param in params) {
            if (typeof params[param] === 'object' && params[param] !== null && !(params[param].nodeType || params[param] === window || params[param] === document || (typeof ZeJS !== 'undefined' && params[param] instanceof ZeJS) || (typeof jQuery !== 'undefined' && params[param] instanceof jQuery))) {
        ...
        /*=========================
          ...
          ===========================*/
        if (typeof $ !== 'undefined' && typeof ZeJS !== 'undefined'){
            $ = ZeJS;
        }
        if (typeof $ === 'undefined') {
            if (typeof ZeJS === 'undefined') {
                $ = window.ZeJS || window.Zepto || window.jQuery;
            }
            else {
                $ = ZeJS;
            }
...
//# sourceMappingURL=ikirin.js.map
